...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
        ...
        <?php echo ( 'post' == get_post_type() && !is_single() || is_search() ) ? '<h2 class="entry-title">' : '<h1 class="entry-title">'; ?>
			...
			<?php	endif;
					...
					<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'primo' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php ( get_the_title() )? the_title() : the_permalink(); ?></a>
			<?php
				endif;
			endif; ?>
	...
	<?php if ( is_single() ) : ?>
    	...
    	<?php cyberchimps_featured_image(); ?>
			<?php the_content( __( 'Continue reading', 'primo' ) . ' <span class="meta-nav">&rarr;</span>' ); ?>
  ...
  <?php elseif( is_archive() ): ?>
	...
	<footer class="entry-meta">
		...
		<?php edit_post_link( __( 'Edit', 'primo' ), '<span class="edit-link">', '</span>' ); ?>
